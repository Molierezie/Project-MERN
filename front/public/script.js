...
let nouveau   = document.querySelector('.new-citation')
let citation  = document.querySelector('#text-citation');
let auteur    = document.querySelector('#auteur-citation');
...
const menuHamburger = document.querySelector(".bar-menu")
